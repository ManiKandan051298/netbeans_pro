...
<html lang="en">
  ...
  <div class="form-group">
    ...
    <input required type="number" name="regno" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Reg no: ">
  </div>
  <div class="form-group">
    ...
    <div class="form-group">
    <label for="exampleInputPassword1">Enter Your Gender</label>n
    <input type="text" required class="form-control" id="exampleInputPassword1" name="gender" placeholder="Gender">
  </div>
   <div class="form-group">
  ...
  <div class="form-group">
    <label for="exampleInputPassword1">Enter Your UG percentage</label>
    <input type="number" required class="form-control" name="percent" id="exampleInputPassword1" placeholder="">
  </div>
   <button type="reset" class=" mx-5 btn btn-warning">Clear</button>
