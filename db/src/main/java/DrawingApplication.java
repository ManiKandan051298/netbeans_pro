...
//		bottom.setLayout(new BorderLayout());
	...
	public static void main(String[] args) {
		// Create the frame.
		JFrame frame = new JFrame("1st qn");
	...
	public class State {
		...
		public State(Color foreground, Color background, boolean gradient, boolean filled
				) {
...
;
	...
	public class ControlPanel extends JPanel {
		...
		protected Drawable createDrawable() {
			...
			State state = new State(foreground.getBackground(), background.getBackground(), dashed.isSelected());
